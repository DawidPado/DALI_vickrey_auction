...
eve(new_item(var_N,var_R,var_P)):-format('item proposed:~w - Rarity: ~w, Price: ~w~n',[var_N,var_R,var_P]),var_Max_offer is var_P+100,random(var_P,var_Max_offer,var_Offer),need(var_Offer),format('I offer:~w ',[var_Offer]),a(message(agent1,send_message(im_in(agent2,var_Offer),var_Me))).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_337191,var_Ontology,_337195),_337185),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_337229)),a(message(var_Ag,propose(var_A,[_337229],var_AgI))),retractall(ext_agent(var_Ag,_337267,var_Ontology,_337271)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_337065,var_Ontology,_337069),_337059),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_337135,var_Ontology,_337139)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_336953,var_Ontology,_336957),_336947),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_337009,var_Ontology,_337013)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_336517),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_336551),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_336333).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_336181),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_336129),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_336005,_336007)),clause(agente(_336027,_336029,_336031,var_S),_336023),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_335799,_335801,_335803,var_S),_335795),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_335899,[]),repeat,read(_335899,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_335899).
